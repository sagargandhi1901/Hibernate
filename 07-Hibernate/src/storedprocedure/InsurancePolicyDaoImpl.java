...
DELIMITER $$
CREATE
    PROCEDURE `crudapp`.`GET_POLICIES_BY_TENURE`(IN tenure1 INT,IN tenure2 INT)
 ...
 * DELIMITER $$
	...
	CREATE
    PROCEDURE `crudapp`.`GET_POLICY_BY_ID`(IN id INT,OUT pName VARCHAR(20),OUT cname VARCHAR(20),
