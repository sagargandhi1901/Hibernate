...
public class UpdateOperationMergeMethod {
	public static void main(String[] args) {
		...
		emp1 = session.get(Employee.class, 20);//[18,'virat',2455.7] ====> L1 Cache(availabe inside session)
		...
		try {
			...
			emp2.setEmpSalary(3334.5);//[18,'virat',2455.7][emp2]
