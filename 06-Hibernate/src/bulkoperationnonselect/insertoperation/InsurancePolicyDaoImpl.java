...
public class InsurancePolicyDaoImpl implements InsurancePolicyDao {
	private static final String HQL_TRANSFER_QUERY = "INSERT INTO bulkoperationnonselect.insertoperation.PremiumInsurancePolicy(policyId,policyName,policyType,company,tenure) SELECT i.policyId,i.policyName,i.policyType,i.company,i.tenure FROM bulkoperationnonselect.insertoperation.InsurancePolicy as i WHERE i.tenure>:tenure";
